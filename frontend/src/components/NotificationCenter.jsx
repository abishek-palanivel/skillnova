                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Outgoing Call - Join Room */}
                        {notification.type === 'video_call' && notification.data?.type === 'outgoing_call' && notification.data?.room_id && (
                          <div className="flex space-x-2 mt-3">
                            <button
                              onClick={() => {
                                markAsRead(notification.id);
                                navigate(`/video-call/${notification.data.room_id}`);
                              }}
                        ...
                        {notification.type === 'video_call' && notification.data?.type === 'call_accepted' && notification.data?.room_id && (
                          <div className="flex space-x-2 mt-3">
                            <button
                              onClick={() => {
                                markAsRead(notification.id);
